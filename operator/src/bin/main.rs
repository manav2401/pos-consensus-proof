...
async fn main() -> anyhow::Result<()> {
    ...
    let inputs = generate_test_input();
    ...
    println!("Successfully generated proof: {:?}", proof_data.bytes());
    println!("Public values: {:?}", proof_data.public_values.to_vec());
...
fn generate_test_input() -> MilestoneProofInputs {
